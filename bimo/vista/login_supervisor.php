...
<body>
				...
				<table border="0" style="width: 70%;" align="center">
					<tr>
						<td style="width: 50%;">
							...
							<h4 style="color: #1C5E55;">Supervisor</h4>
						...
						<td style="width: 50%;">
							<a href="../vista/login_admin.php">
								<img src="../uploads/admin.png" title="Acceder al sistema como Administrador">
							</a>

							<a href="../vista/login_guarda.php">
								<img src="../uploads/guarda.png" title="Acceder al sistema como Guarda de Seguridad">
							</a>
						</td>
					</tr>
				</table>
    ...
    <script src="../vista/js/ini.js"></script>
    <script src="../vista/js/jquery.anexsoft-validator.js"></script>
</body>
</html>