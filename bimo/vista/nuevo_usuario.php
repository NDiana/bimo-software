...
<h1 class="page-header" style="color: #1C5E55;">
    <?php echo $alm->__GET('id') != null ? $alm->__GET('nombre') : 'Añadir usuario común'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=Usuario" style="color: #1CA794;">Lista de Usuarios Registrados</a></li>
  <li class="active">Registro Múltiple de Usuarios</li>
</ol>
    ...
    <div class="col-xs-4">
        <div class="well well-sm">
            ...
            <div class="form-group">
                ...
                <input type="text" name="email[]" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@misena.edu.co" title="Por favor introduzca la dirección de correo electrónico requerida. Ejemplo: tucuenta@misena.edu.co" data-validacion-tipo="requerido|email" />
            </div>
