...
var validarRadios = function(){
	var opciones = document.getElementsByName('tipo_documento'),
		resultado = false;

	for (var i = 0; i < elementos.length; i++) {
		if(elementos[i].type == "radio" && elementos[i].name == "tipo_documento"){
			...
			if (resultado == false) {
				...
				console.log('El campo tipo documento esta incompleto');
				return false;
			} else {
